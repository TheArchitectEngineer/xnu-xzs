...
REGRESSION_TELEMETRY = {
    "PID1_FD1_EXISTS": "yes",
    "PID1_FD1_TARGET": "/dev/console",
    "PID1_FD1_READY_FOR_WRITE": "yes",
    "SYSCALL_RETURN_VALUE": "0x000000000000001a",
    "SYSCALL_RETURN_ERROR": "0",
    "SYSCALL_RETURN_CARRY": "clear",
    "POST_SYSCALL_EL0_PC": "0x000000010000030c",
    "POST_SYSCALL_REGISTER_SIGNATURE": "x0:26,x16:20,carry:clear",
}
...
def main():
    ...
    required = dict(COMMON_TELEMETRY)
    required.update(REGRESSION_TELEMETRY if regression_mode else HISTORICAL_TELEMETRY)
    ...
    print("D6_M5_REGRESSION_VERIFIER: PASS" if regression_mode else "D6_M5_ACCEPTANCE_VERIFIER: PASS")
