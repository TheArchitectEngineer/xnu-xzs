#!/usr/bin/env python3
"""D8-M8-7 Retry #2 Controlled Single Kickoff Hardware Runner.
Executes prerequisites M2..M6, M8-1..M8-6 (with corrected PP0 timing and DSI_CMD_MDP_CTRL=0x06100006),
...
Saves all evidence to artifacts/hw/d8m8/m8-7-retry2/.
"""
...
def main():
    parser = argparse.ArgumentParser(description="D8-M8-7 Retry #2 Controlled Kickoff Runner")
    parser.add_argument("--log-dir", default="artifacts/hw/d8m8/m8-7-retry2",
    ...
    print("=== D8-M8-7 RETRY #2 HARDWARE RUNNER START ===", flush=True)
    ...
    # =========================================================================
    # 7. EXECUTING M8-7 RETRY #2: CONTROLLED SINGLE KICKOFF
    # =========================================================================
    print("\n=======================================================", flush=True)
    print("=== EXECUTING M8-7 RETRY #2: CONTROLLED SINGLE KICKOFF ===", flush=True)
    print("=======================================================", flush=True)

    kickoff_out = run_step("M8-7 RETRY #2 KICKOFF", "display m8-kickoff\n", 15.0, required_substr="M8_7=")
    ...
    # Final Verification
    print("\n=== FINAL M8-7 RETRY #2 VERIFICATION ===", flush=True)
    if "M8_7=PASS" in kickoff_out:
        print(">>> RESULT: M8-7 RETRY #2 PASS! First MDP command-mode frame scanned out! <<<", flush=True)
    else:
        print(">>> RESULT: M8-7 RETRY #2 FAIL or TIMEOUT! Check artifacts for details. <<<", flush=True)
