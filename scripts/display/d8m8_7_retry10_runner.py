#!/usr/bin/env python3
"""D8-M8-7 Retry #10: Qualcomm Software-TE / Internal VSYNC Override.
...
Captures high-frequency diagnostics across 0-50ms (13 points) and poll loop.
Halts strictly after one attempt.
Saves all evidence to artifacts/hw/d8m8/m8-7-retry10/.
"""
...
def main():
    parser = argparse.ArgumentParser(description="D8-M8-7 Retry #10 Qualcomm Software-TE / Internal VSYNC Override Runner")
    parser.add_argument("--log-dir", default="artifacts/hw/d8m8/m8-7-retry10",
    ...
    print("=== D8-M8-7 RETRY #10 HARDWARE RUNNER START ===", flush=True)
    ...
    print("\n=== EXECUTING STAGE M8-4: PP0 & DSI MDP STREAM PROGRAMMING (RETRY #10 SW-TE OVERRIDE) ===", flush=True)
    ...
    # =========================================================================
    # 7. EXECUTING M8-7 RETRY #10: CONTROLLED SINGLE KICKOFF
    # =========================================================================
    print("\n=======================================================", flush=True)
    print("=== EXECUTING M8-7 RETRY #10: CONTROLLED SINGLE KICKOFF ===", flush=True)
    print("=======================================================", flush=True)

    kickoff_out = run_step("M8-7 RETRY #10 KICKOFF", "display m8-kickoff\n", 25.0, required_substr="M8_7_RETRY10=")
    ...
    # Final Verification
    print("\n=== FINAL M8-7 RETRY #10 VERIFICATION ===", flush=True)
    if "M8_7_RETRY10=PASS" in kickoff_out:
        print(">>> RESULT: M8-7 RETRY #10 PASS! First MDP command-mode frame scanned out! <<<", flush=True)
    else:
        print(">>> RESULT: M8-7 RETRY #10 FAIL or TIMEOUT! Check artifacts for details. <<<", flush=True)
