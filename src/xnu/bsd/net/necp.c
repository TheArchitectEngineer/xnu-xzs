...
necp_generate_resolver_key(void)
{
	...
	xzs_early_puts("      [NECP-RESKEY-0] enter necp_generate_resolver_key\n");
	xzs_watchdog_pet();
	s_necp_resolver_key_state.digest_info = ccsha256_di();
	xzs_early_puts("      [NECP-RESKEY-1] ccsha256_di done\n");
	xzs_watchdog_pet();
	cc_rand_generate(s_necp_resolver_key_state.key, sizeof(s_necp_resolver_key_state.key));
	xzs_early_puts("      [NECP-RESKEY-2] cc_rand_generate done\n");
	xzs_watchdog_pet();
}
...
necp_generate_application_id_key(void)
{
	...
	xzs_early_puts("      [NECP-APPKEY-0] enter necp_generate_application_id_key\n");
	xzs_watchdog_pet();
	s_necp_application_id_key_state.digest_info = ccsha256_di();
	xzs_early_puts("      [NECP-APPKEY-1] ccsha256_di done\n");
	xzs_watchdog_pet();
	cc_rand_generate(s_necp_application_id_key_state.key, sizeof(s_necp_application_id_key_state.key));
	xzs_early_puts("      [NECP-APPKEY-2] cc_rand_generate done\n");
	xzs_watchdog_pet();
}
...
necp_init(void)
{
	...
	xzs_early_puts("    [NECP-A] necp_init enter\n");
	xzs_watchdog_pet();

	xzs_early_puts("    [NECP-B] calling os_log_create\n");
	xzs_watchdog_pet();
	...
	xzs_early_puts("    [NECP-C] os_log_create returned\n");
	xzs_watchdog_pet();

	xzs_early_puts("    [NECP-D] calling necp_client_init\n");
	xzs_watchdog_pet();
	necp_client_init();
	xzs_early_puts("    [NECP-E] necp_client_init returned\n");
	xzs_watchdog_pet();
	...
	xzs_early_puts("    [NECP-F] list init done, calling necp_generate_resolver_key\n");
	xzs_watchdog_pet();
	necp_generate_resolver_key();
	xzs_early_puts("    [NECP-G] necp_generate_resolver_key returned\n");
	xzs_watchdog_pet();

	xzs_early_puts("    [NECP-H] calling necp_generate_application_id_key\n");
	xzs_watchdog_pet();
	necp_generate_application_id_key();
	xzs_early_puts("    [NECP-I] necp_generate_application_id_key returned\n");
	xzs_watchdog_pet();

	xzs_early_puts("    [NECP-J] calling hashinit\n");
	xzs_watchdog_pet();
	...
	xzs_early_puts("    [NECP-K] hashinit returned\n");
	xzs_watchdog_pet();
	...
	xzs_early_puts("    [NECP-L] calling get_first_order_for_priority\n");
	xzs_watchdog_pet();
	necp_drop_unentitled_order = necp_get_first_order_for_priority(necp_drop_unentitled_level);
	necp_drop_management_order = necp_get_first_order_for_priority(necp_drop_management_level);

	xzs_early_puts("    [NECP-M] necp_init complete\n");
	xzs_watchdog_pet();
}
