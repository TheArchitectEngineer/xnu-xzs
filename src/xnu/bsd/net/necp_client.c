...
necp_client_init(void)
{
	...
	xzs_early_puts("      [NECP-CLIENT-0] enter necp_client_init\n");

	xzs_early_puts("      [NECP-CLIENT-1] before update_tcall allocate\n");
	...
	xzs_early_puts("      [NECP-CLIENT-2] after update_tcall allocate\n");
	xzs_watchdog_pet();

#if SKYWALK
	xzs_early_puts("      [NECP-CLIENT-3] before stats_tcall allocate\n");
	...
	xzs_early_puts("      [NECP-CLIENT-4] after stats_tcall allocate\n");
	xzs_watchdog_pet();

	xzs_early_puts("      [NECP-CLIENT-5] before arenas_tcall allocate\n");
	...
	xzs_early_puts("      [NECP-CLIENT-6] after arenas_tcall allocate\n");
	xzs_watchdog_pet();
#endif /* SKYWALK */

	xzs_early_puts("      [NECP-CLIENT-7] before list/tree inits\n");
	...
	xzs_early_puts("      [NECP-CLIENT-8] after list/tree inits\n");
	xzs_watchdog_pet();

	xzs_early_puts("      [NECP-CLIENT-9] return necp_client_init\n");
	xzs_watchdog_pet();
}
