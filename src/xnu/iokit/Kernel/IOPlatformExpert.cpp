...
class IOPanicPlatform : public IOPlatformExpert {
...
IOPanicPlatform::start(IOService * provider)
{
	...
	xzs_early_puts("  [IOPlatformExpert] IOPanicPlatform matching for: ");
	xzs_early_puts(platform_name);
	xzs_early_puts(" — operating as headless fallback platform expert\n");
