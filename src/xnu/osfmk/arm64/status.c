...
xzs_d6m4_monitor_and_report_r650(task_t t, thread_t th)
{
	...
	if (xzs_d6m4_r650_telemetry.stable_roundtrip_count >= 256 &&
		...
		/* Telemetry reporting for Candidate-2B DCFG-only normalization. */
		xzs_early_puts("\n=======================================================\n");
		xzs_early_puts("=== D7-T1 CANDIDATE-2B DCFG NORMALIZATION TELEMETRY BEGIN ===\n");
		...
		xzs_early_puts("PRECONDITION_RUN_STOP_0="); xzs_early_puts(g_xzs_usb_candidate2b_precondition_run_stop_0 ? "yes\n" : "no\n");
		xzs_early_puts("PRECONDITION_DEVCTRLHLT_1="); xzs_early_puts(g_xzs_usb_candidate2b_precondition_devctrlhlt_1 ? "yes\n" : "no\n");
		xzs_early_puts("DWC3_GCTL_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gctl_before); xzs_early_puts("\n");
		xzs_early_puts("DWC3_GCTL_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gctl); xzs_early_puts("\n");
		xzs_early_puts("DWC3_GUSB2PHYCFG0_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gusb2phycfg0_before); xzs_early_puts("\n");
		xzs_early_puts("DWC3_GUSB2PHYCFG0_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gusb2phycfg0); xzs_early_puts("\n");
		...
		xzs_early_puts("DWC3_DCFG_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_dcfg_before); xzs_early_puts("\n");
		xzs_early_puts("DWC3_DCFG_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_dcfg); xzs_early_puts("\n");
		xzs_early_puts("DCFG_DEVSPD_BEFORE="); xzs_early_puts((g_xzs_usb_dcfg_before & 7u) == 4 ? "SUPER_SPEED_ENCODING\n" : "OTHER\n");
		xzs_early_puts("DCFG_DEVSPD_AFTER="); xzs_early_puts((g_xzs_usb_dcfg_readback & 7u) == 0 ? "HIGH_SPEED\n" : "OTHER\n");
		xzs_early_puts("DCFG_DEVADDR_BEFORE="); xzs_d6m4_put_hex64((g_xzs_usb_dcfg_before >> 3) & 0x7fu); xzs_early_puts("\n");
		xzs_early_puts("DCFG_DEVADDR_AFTER="); xzs_d6m4_put_hex64((g_xzs_usb_dcfg_readback >> 3) & 0x7fu); xzs_early_puts("\n");
		xzs_early_puts("DCFG_NUMP_BEFORE="); xzs_d6m4_put_hex64((g_xzs_usb_dcfg_before >> 17) & 0x1fu); xzs_early_puts("\n");
		xzs_early_puts("DCFG_NUMP_AFTER="); xzs_d6m4_put_hex64((g_xzs_usb_dcfg_readback >> 17) & 0x1fu); xzs_early_puts("\n");
		xzs_early_puts("DCFG_WRITE_MATCH="); xzs_early_puts(g_xzs_usb_candidate2b_dcfg_write_match ? "yes\n" : "no\n");
		...
		xzs_early_puts("INHERITED_GEVNTADR_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntadr0_before); xzs_early_puts("\n");
		xzs_early_puts("INHERITED_GEVNTSIZ_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntsiz0_before); xzs_early_puts("\n");
		xzs_early_puts("INHERITED_GEVNTCOUNT_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntcnt0_before); xzs_early_puts("\n");
		xzs_early_puts("INHERITED_GEVNTADR_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntadr0); xzs_early_puts("\n");
		xzs_early_puts("INHERITED_GEVNTSIZ_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntsiz0); xzs_early_puts("\n");
		xzs_early_puts("INHERITED_GEVNTCOUNT_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntcnt0); xzs_early_puts("\n");
		xzs_early_puts("QSCRATCH_HS_PHY_CTRL_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_qscratch_hs_phy_ctrl_before); xzs_early_puts("\n");
		...
		xzs_early_puts("GCC_QUSB2PHY_PRIM_BCR_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gcc_qusb2phy_prim_bcr); xzs_early_puts("\n");
		xzs_early_puts("DWC3_GSNPSID_VALID="); xzs_early_puts(gsnpsid_valid ? "yes\n" : "no\n");
		xzs_early_puts("CANDIDATE2B_DWC3_WRITE_COUNT="); xzs_d6m4_put_hex64(g_xzs_usb_candidate2b_write_count); xzs_early_puts("\n");
		xzs_early_puts("CANDIDATE2B_DWC3_WRITE_TARGET=DCFG\n");
		xzs_early_puts("DCFG_WRITE_COUNT="); xzs_d6m4_put_hex64(g_xzs_usb_candidate2b_write_count); xzs_early_puts("\n");
		xzs_early_puts("DWC3_WRITE_TARGET=DCFG\n");
		xzs_early_puts("GCTL_UNCHANGED="); xzs_early_puts(g_xzs_usb_candidate2b_gctl_unchanged ? "yes\n" : "no\n");
		xzs_early_puts("GUSB2PHYCFG0_UNCHANGED="); xzs_early_puts(g_xzs_usb_candidate2b_gusb2phycfg0_unchanged ? "yes\n" : "no\n");
		xzs_early_puts("QSCRATCH_UNCHANGED="); xzs_early_puts(g_xzs_usb_candidate2b_qscratch_unchanged ? "yes\n" : "no\n");
		xzs_early_puts("QUSB2_UNCHANGED="); xzs_early_puts(g_xzs_usb_candidate2b_qusb2_unchanged ? "yes\n" : "no\n");
		xzs_early_puts("GCC_UNCHANGED="); xzs_early_puts(g_xzs_usb_candidate2b_gcc_unchanged ? "yes\n" : "no\n");
		xzs_early_puts("EVENT_BUFFER_UNCHANGED="); xzs_early_puts(g_xzs_usb_candidate2b_event_buffer_unchanged ? "yes\n" : "no\n");
		...
		xzs_early_puts("CANDIDATE2B_COMPLETE="); xzs_early_puts(g_xzs_usb_candidate2b_complete ? "yes\n" : "no\n");
		...
		xzs_early_puts("=== D7-T1 CANDIDATE-2B DCFG NORMALIZATION TELEMETRY END ===\n");
		xzs_early_puts("=======================================================\n\n");
