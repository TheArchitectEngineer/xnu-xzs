...
xzs_d6m4_monitor_and_report_r650(task_t t, thread_t th)
{
	...
	if (xzs_d6m4_r650_telemetry.stable_roundtrip_count >= 256 &&
		...
		xzs_early_puts("[XZS-D6M4] D630/50 first SVC identity preserved; D6-M5 dispatch enabled\n");

		xzs_early_puts("\n=== D6-M4 REGRESSION TELEMETRY BEGIN ===\n");
		...
		xzs_early_puts("=== D6-M4 REGRESSION TELEMETRY END ===\n");
		xzs_breadcrumb(0xD630, 0x90);
		xzs_breadcrumb(0xD630, 0x91);
		xzs_early_puts("[XZS-D6M4] D6-M4 REGRESSION VERIFIED (PASS)\n");
		xzs_breadcrumb(0xD630, 0x01);
		xzs_early_puts("[XZS-D6M4] D630/01 regression handoff to D6-M5\n");

		if (!xzs_d6m4_r650_telemetry.syscall_classified ||
		    !xzs_d6m4_r650_telemetry.dispatcher_reached ||
		    !xzs_d6m4_r650_telemetry.handler_entered ||
		    !xzs_d6m4_r650_telemetry.handler_completed ||
		    !xzs_d6m4_r650_telemetry.syscall_return_prepared ||
		    !xzs_d6m4_r650_telemetry.sleh_return_ready ||
		    !xzs_d6m4_r650_telemetry.post_signature_valid) {
			xzs_breadcrumb(0xD640, 0xEE70);
			xzs_early_puts("[XZS-D6M5] FATAL: incomplete first syscall round-trip telemetry\n");
			xzs_spin_halt();
		}
		...
		xzs_breadcrumb(0xD640, 0x10);
		xzs_early_puts("[XZS-D6M5] D640/10 first SVC64 entered\n");
		xzs_breadcrumb(0xD640, 0x20);
		xzs_early_puts("[XZS-D6M5] D640/20 syscall classified as BSD write(2)\n");
		xzs_breadcrumb(0xD640, 0x30);
		xzs_early_puts("[XZS-D6M5] D640/30 unix_syscall dispatcher reached\n");
		xzs_breadcrumb(0xD640, 0x40);
		xzs_early_puts("[XZS-D6M5] D640/40 sysent[4] write handler entered\n");
		xzs_breadcrumb(0xD640, 0x50);
		xzs_early_puts("[XZS-D6M5] D640/50 write handler completed\n");
		...
		xzs_early_puts("D6-M4_REGRESSION_PASS=yes\n");
		xzs_early_puts("FIRST_SVC_ENTERED=yes\n");
		xzs_early_puts("SYSCALL_ABI_SOURCE_AUDITED=yes\n");
		...
		xzs_early_puts("ROADMAP_ADVANCED_TO=D6-M6\n");
		...
		/* --- Phase D7-T1: Minimal USB-C Bulk Console (Candidate 1: READ-ONLY PROBE) --- */
		extern int xzs_usb_init(void);
		extern volatile uint32_t g_xzs_usb_gsnpsid;
		...
		xzs_early_puts("GHWPARAMS1=0x"); xzs_d6m4_put_hex64(g_xzs_usb_ghwparams1); xzs_early_puts("\n");
		xzs_early_puts("DWC3_NUM_EVENT_INTERRUPTS="); xzs_d6m4_put_hex64(g_xzs_usb_num_event_interrupts); xzs_early_puts("\n");
		xzs_early_puts("PRECONDITION_RUN_STOP_0="); xzs_early_puts(g_xzs_usb_candidate2c_precondition_run_stop_0 ? "yes\n" : "no\n");
		xzs_early_puts("PRECONDITION_DEVCTRLHLT_1="); xzs_early_puts(g_xzs_usb_candidate2c_precondition_devctrlhlt_1 ? "yes\n" : "no\n");
		xzs_early_puts("DCFG_RAW_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_dcfg_before); xzs_early_puts("\n");
		xzs_early_puts("DCFG_RAW_WRITTEN=0x"); xzs_d6m4_put_hex64(g_xzs_usb_dcfg_written); xzs_early_puts("\n");
		xzs_early_puts("DCFG_RAW_READBACK=0x"); xzs_d6m4_put_hex64(g_xzs_usb_dcfg_readback); xzs_early_puts("\n");
		xzs_early_puts("DCFG_HIGH_SPEED="); xzs_early_puts(g_xzs_usb_candidate2c_dcfg_high_speed ? "yes\n" : "no\n");
		xzs_early_puts("DCFG_DEVADDR_ZERO="); xzs_early_puts(g_xzs_usb_candidate2c_dcfg_devaddr_0 ? "yes\n" : "no\n");
		xzs_early_puts("EVENT_BUFFER_VA=0x"); xzs_d6m4_put_hex64(g_xzs_usb_candidate2c_event_buffer_va); xzs_early_puts("\n");
		xzs_early_puts("EVENT_BUFFER_PA=0x"); xzs_d6m4_put_hex64(g_xzs_usb_candidate2c_event_buffer_pa); xzs_early_puts("\n");
		xzs_early_puts("EVENT_BUFFER_SIZE=4096\n");
		xzs_early_puts("EVENT_BUFFER_PA_VALID="); xzs_early_puts(g_xzs_usb_candidate2c_event_buffer_pa_valid ? "yes\n" : "no\n");
		xzs_early_puts("EVENT_BUFFER_PHYS_CONTIGUOUS="); xzs_early_puts(g_xzs_usb_candidate2c_event_buffer_contiguous ? "yes\n" : "no\n");
		xzs_early_puts("EVENT_BUFFER_ALIGNMENT_VALID="); xzs_early_puts(g_xzs_usb_candidate2c_event_buffer_aligned ? "yes\n" : "no\n");
		xzs_early_puts("EVENT_BUFFER_LIFETIME_STATIC="); xzs_early_puts(g_xzs_usb_candidate2c_event_buffer_lifetime_static ? "yes\n" : "no\n");
		xzs_early_puts("EVENT_BUFFER_DMA_POLICY_AUDITED=yes\n");
		xzs_early_puts("EVENT_BUFFER_DMA_ACTIVITY_EXPECTED=no\n");
		xzs_early_puts("GEVNTADRLO_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntadr0_before); xzs_early_puts("\n");
		xzs_early_puts("GEVNTADRHI_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntadrhi0_before); xzs_early_puts("\n");
		xzs_early_puts("GEVNTSIZ_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntsiz0_before); xzs_early_puts("\n");
		xzs_early_puts("GEVNTCOUNT_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntcnt0_before); xzs_early_puts("\n");
		xzs_early_puts("GEVNTADRLO_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntadr0); xzs_early_puts("\n");
		xzs_early_puts("GEVNTADRHI_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntadrhi0); xzs_early_puts("\n");
		xzs_early_puts("GEVNTSIZ_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntsiz0); xzs_early_puts("\n");
		xzs_early_puts("GEVNTCOUNT_ACK_VALUE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_candidate2c_gevntcount_ack); xzs_early_puts("\n");
		xzs_early_puts("GEVNTCOUNT_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_gevntcnt0); xzs_early_puts("\n");
		xzs_early_puts("GEVNTADR_READBACK_MATCH="); xzs_early_puts(g_xzs_usb_candidate2c_gevntadr_readback_match ? "yes\n" : "no\n");
		xzs_early_puts("GEVNTSIZ_SIZE=4096\n");
		xzs_early_puts("GEVNTSIZ_INTMASK="); xzs_early_puts((g_xzs_usb_gevntsiz0 & (1u << 31)) ? "1\n" : "0\n");
		xzs_early_puts("DWC3_DCTL_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_dctl_before); xzs_early_puts("\n");
		xzs_early_puts("DWC3_DCTL_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_dctl); xzs_early_puts("\n");
		xzs_early_puts("RUN_STOP_BEFORE="); xzs_early_puts((g_xzs_usb_dctl_before & (1u << 31)) ? "1\n" : "0\n");
		xzs_early_puts("RUN_STOP_AFTER="); xzs_early_puts((g_xzs_usb_dctl & (1u << 31)) ? "1\n" : "0\n");
		xzs_early_puts("DWC3_DSTS_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_dsts_before); xzs_early_puts("\n");
		xzs_early_puts("DWC3_DSTS_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_dsts); xzs_early_puts("\n");
		xzs_early_puts("DEVCTRLHLT_BEFORE="); xzs_early_puts((g_xzs_usb_dsts_before & (1u << 22)) ? "1\n" : "0\n");
		xzs_early_puts("DEVCTRLHLT_AFTER="); xzs_early_puts((g_xzs_usb_dsts & (1u << 22)) ? "1\n" : "0\n");
		xzs_early_puts("DEVTEN_BEFORE=0x"); xzs_d6m4_put_hex64(g_xzs_usb_devten_before); xzs_early_puts("\n");
		xzs_early_puts("DEVTEN_AFTER=0x"); xzs_d6m4_put_hex64(g_xzs_usb_devten); xzs_early_puts("\n");
		xzs_early_puts("DEVTEN_UNCHANGED="); xzs_early_puts(g_xzs_usb_candidate2c_devten_unchanged ? "yes\n" : "no\n");
		xzs_early_puts("DWC3_WRITE_SET=DCFG_IF_REQUIRED,GEVNTADRLO0,GEVNTADRHI0,GEVNTSIZ0,GEVNTCOUNT0_IF_PENDING\n");
		xzs_early_puts("CANDIDATE2C_DCFG_WRITE_COUNT="); xzs_d6m4_put_hex64(g_xzs_usb_candidate2c_dcfg_write_count); xzs_early_puts("\n");
		xzs_early_puts("GEVNTADRLO_WRITE_COUNT="); xzs_d6m4_put_hex64(g_xzs_usb_candidate2c_gevntadrlo_write_count); xzs_early_puts("\n");
		xzs_early_puts("GEVNTADRHI_WRITE_COUNT="); xzs_d6m4_put_hex64(g_xzs_usb_candidate2c_gevntadrhi_write_count); xzs_early_puts("\n");
		xzs_early_puts("GEVNTSIZ_WRITE_COUNT="); xzs_d6m4_put_hex64(g_xzs_usb_candidate2c_gevntsiz_write_count); xzs_early_puts("\n");
		xzs_early_puts("GEVNTCOUNT_WRITE_COUNT="); xzs_d6m4_put_hex64(g_xzs_usb_candidate2c_gevntcount_write_count); xzs_early_puts("\n");
		xzs_early_puts("EP0_UNTOUCHED=yes\n");
		xzs_early_puts("DEPCMD_WRITE_COUNT=0\n");
		xzs_early_puts("DALEPENA_WRITE_COUNT=0\n");
		xzs_early_puts("DCTL_WRITE_COUNT=0\n");
		xzs_early_puts("GCTL_WRITE_COUNT=0\n");
		xzs_early_puts("DEVTEN_WRITE_COUNT=0\n");
		xzs_early_puts("QSCRATCH_WRITE_COUNT=0\n");
		xzs_early_puts("QUSB2_WRITE_COUNT=0\n");
		xzs_early_puts("GCC_WRITE_COUNT=0\n");
		xzs_early_puts("DCTL_RUN_STOP_AFTER="); xzs_early_puts((g_xzs_usb_dctl & (1u << 31)) ? "1\n" : "0\n");
		xzs_early_puts("DSTS_DEVCTRLHLT_AFTER="); xzs_early_puts((g_xzs_usb_dsts & (1u << 22)) ? "1\n" : "0\n");
		xzs_early_puts("EVENT_BUFFER_XNU_OWNED="); xzs_early_puts(g_xzs_usb_candidate2c_complete ? "yes\n" : "no\n");
		xzs_early_puts("EVENT_BUFFER_OWNERSHIP_PROGRAMMED="); xzs_early_puts(g_xzs_usb_candidate2c_complete ? "yes\n" : "no\n");
		xzs_early_puts("EVENT_BUFFER_REGISTER_READBACK="); xzs_early_puts(g_xzs_usb_candidate2c_gevntadr_readback_match && g_xzs_usb_candidate2c_gevntsiz_readback_match ? "yes\n" : "no\n");
		xzs_early_puts("EVENT_BUFFER_DMA_WORKING=NOT_TESTED\n");
		xzs_early_puts("CANDIDATE2C_COMPLETE="); xzs_early_puts(g_xzs_usb_candidate2c_complete ? "yes\n" : "no\n");
