...
static const struct m3_reg_write s_m3_writes[68] = {
    ...
    { 0x00994804u, 0x00000007u, "D8M3-30", "Enable Tx clock channels" },
    { 0x00994810u, 0x00000005u, "D8M3-30", "Reset SM control 3" },
    { 0x00994828u, 0x00000020u, "D8M3-30", "Reset SM counter initial" },
    { 0x0099482cu, 0x00000000u, "D8M3-30", "Clear backup control" },
    { 0x00994830u, 0x00000038u, "D8M3-30", "Kvco divider reference 1" },
    { 0x0099483cu, 0x00000057u, "D8M3-30", "Lock cmp low byte (0x957)" },
    { 0x00994840u, 0x00000009u, "D8M3-30", "Lock cmp high byte (0x957)" },
    { 0x00994844u, 0x00000000u, "D8M3-30", "Lock cmp upper byte" },
    { 0x00994848u, 0x00000001u, "D8M3-30", "Enable lock comparison" },
    { 0x0099484cu, 0x00000019u, "D8M3-30", "Min lock delay cycles" },
    { 0x0099486cu, 0x0000005du, "D8M3-30", "Decimation start (93)" },
    { 0x00994870u, 0x000000f0u, "D8M3-30", "Frac start byte 0 (0x740f0)" },
    { 0x00994874u, 0x00000040u, "D8M3-30", "Frac start byte 1 (0x740f0)" },
    { 0x00994878u, 0x00000007u, "D8M3-30", "Frac start byte 2 (0x740f0)" },
    { 0x0099487cu, 0x00000033u, "D8M3-30", "VCO divider ref 1" },
    { 0x00994880u, 0x00000003u, "D8M3-30", "VCO divider ref 2" },
    { 0x00994884u, 0x0000000bu, "D8M3-30", "Charge pump current" },
    { 0x00994888u, 0x0000001fu, "D8M3-30", "Loop filter resistor 1" },
    { 0x00994890u, 0x00000000u, "D8M3-30", "Loop filter capacitor 1" },
    { 0x00994894u, 0x00000030u, "D8M3-30", "Loop filter capacitor 2" },
    { 0x00994898u, 0x00000000u, "D8M3-30", "Disable BIST mode" },
    { 0x0099489cu, 0x00000002u, "D8M3-30", "Reset SM control 4" },
    { 0x009948a0u, 0x00000000u, "D8M3-30", "Reset SM control 5" },
    { 0x009948a4u, 0x00000000u, "D8M3-30", "Kvco count 1" },
    { 0x009948a8u, 0x00000000u, "D8M3-30", "Kvco count 2" },
    { 0x009948acu, 0x00000014u, "D8M3-30", "Calibration config 0" },
    { 0x009948b4u, 0x00000000u, "D8M3-30", "Calibration config 1" },
    { 0x009948b8u, 0x00000000u, "D8M3-30", "Calibration config 2" },
    { 0x009948bcu, 0x00000000u, "D8M3-30", "Calibration config 3" },
    { 0x009948c0u, 0x00000000u, "D8M3-30", "Calibration config 4" },
    { 0x009948c4u, 0x00000000u, "D8M3-30", "Calibration config 5" },
    { 0x009948e8u, 0x00000000u, "D8M3-30", "Calibration config 6" },
    { 0x009948f0u, 0x00000000u, "D8M3-30", "Calibration config 7" },
    { 0x009948f4u, 0x00000000u, "D8M3-30", "Calibration config 8" },
    { 0x009948f8u, 0x00000000u, "D8M3-30", "Calibration config 9" },
    { 0x009948fcu, 0x00000000u, "D8M3-30", "Calibration config 10" },
    { 0x00994900u, 0x00000000u, "D8M3-30", "Calibration config 11" },
    { 0x00994904u, 0x00000020u, "D8M3-30", "Efuse config 1" },
    { 0x00994410u, 0x0000001eu, "D8M3-30", "PHY common control 0" },
    { 0x00994414u, 0x00000000u, "D8M3-30", "PHY common control 1" },
    { 0x0099441cu, 0x00000000u, "D8M3-30", "PHY common control 2" },
    ...
    { 0x008c2124u, 0x00000200u, "D8M3-70", "Select DSI0 PLL Byte Mux" },
